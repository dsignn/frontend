 ...
 * @polymer
 */
class WidgetNumberUser extends RefreshCollectionData(StorageCrudMixin(LocalizeMixin(ServiceInjectorMixin(PolymerElement)))) {
...
window.customElements.define('widget-number-user', WidgetNumberUser);
