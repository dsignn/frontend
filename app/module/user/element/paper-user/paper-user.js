 ...
 * @polymer
 */
class PaperUser extends StorageEntityMixin(LocalizeMixin(ServiceInjectorMixin(PolymerElement))) {
        ...
        return html`
            <style >
                ...
                #leftSection {
                    ...
                    background-image: url("../../module/user/element/paper-user/img/user.jpg") !important;
...
window.customElements.define('paper-user', PaperUser);
