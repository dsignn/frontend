 ...
 * @polymer
 */
class WidgetNumberResource extends RefreshCollectionData(StorageCrudMixin(LocalizeMixin(ServiceInjectorMixin(PolymerElement)))) {
...
window.customElements.define('widget-number-resource', WidgetNumberResource);
